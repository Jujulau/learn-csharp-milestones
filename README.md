...
- [ x ] ✏️ Open the reference manual for any component from inside Unity. Paste the link: file:///Applications/Unity/Hub/Editor/2020.2.2f1/Documentation/en/Manual/class-Transform.html
- [ x ] ✏️ Find the button to jump to the scripting reference the any reference manual page. Paste the link: file:///Applications/Unity/Hub/Editor/2020.2.2f1/Documentation/en/ScriptReference/index.html
